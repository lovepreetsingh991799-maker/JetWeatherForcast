package com.noisefit.jetweatherforcast.screens.splash
...
fun WeatherSplashScreen(navController: NavController){
    ...
    Surface(modifier = Modifier.padding(15.dp)
        ...
        Column(modifier = Modifier.padding(1.dp),
            ...
            Image(painter = painterResource(R.drawable.ic_weather_forcast_icon),
                contentDescription ="weather forcast icon",
